 ...
 */
public class ScheduleFragAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_schedule_frag_admin, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), Chooser2.class));
            }
        });
    ...
    private void showUpdateDialog(final String descricao, final String url, final String id) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query applesQuery = ref.child("Horarios").orderByChild("key").equalTo(id);
                ...
                applesQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(getContext(), "Horário eliminado com sucesso!", Toast.LENGTH_LONG).show();
                        alertDialog.dismiss();
                    }
